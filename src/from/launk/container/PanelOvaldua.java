...
public class PanelOvaldua extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        this.glass = new GradientPaint(0.0F, 0.0F, new Color(1.0F, 1.0F, 1.0F, 0.5F), 0.0F, getHeight(), new Color(1.0F, 1.0F, 1.0F, 0.5F));
